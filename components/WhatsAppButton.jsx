...
export default function WhatsAppButton() {
  return (
    <WhatsAppLink
      ...
      className="fixed bottom-4 right-4 z-50 hidden items-center gap-3 rounded-full bg-emerald-600 px-5 py-3 text-sm font-semibold text-white shadow-soft transition-all duration-200 ease-in-out hover:bg-emerald-700 active:scale-[0.98] sm:bottom-6 sm:right-6 md:inline-flex md:hover:shadow-lg motion-safe:animate-soft-pulse"
